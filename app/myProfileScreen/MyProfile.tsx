...
const MyProfile = () => {
  ...
  const [abbreviation, setAbbreviation] = React.useState<string|undefined>();
      ...
      <ScrollView style={{ backgroundColor: "#ecedea" }}>
        <View style={Styles.container}>
          <View style={Styles.profile_container}>
            {
                abbreviation && <Text style={Styles.profile_text_style}>{abbreviation}</Text>
            }
          </View>
          <TouchableOpacity
            onPress={() => router.push("/editProfileScreen/EditProfile")}
          >
        ...
        <View style={Styles.option_card}>
          <OptionCard
            ...
            toggle={false}
            redirect="/myProfileScreen/FeedbackAndSupport"
          />
          <OptionCard
