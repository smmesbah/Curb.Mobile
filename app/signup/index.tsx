import { SafeAreaView, StyleSheet, Text, TextInput, TouchableOpacity, View, Image, Dimensions, ScrollView } from 'react-native'
      ...
      <ScrollView>
        ...
        <View style={{ gap: 10, alignItems: 'flex-start', marginTop: 0, paddingHorizontal: 30, justifyContent: 'center' }}>
          ...
          <TouchableOpacity onPress={() => setResearch(!research)} style={styles.rememberMe}>
            ...
            <Text style={styles.rememberMeText}>Join our research group <Link href='#' style={{color: '#5B4AFF'}}>(What does this involve?)</Link></Text>
          </TouchableOpacity>
        </View>
