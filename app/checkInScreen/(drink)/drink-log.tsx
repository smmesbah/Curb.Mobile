import { Dimensions, Image, Pressable, SafeAreaView, StyleSheet, Text, TouchableOpacity, View, ScrollView } from 'react-native'
            ...
            <ScrollView>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <TouchableOpacity
                                onPress={() => router.push(`/checkInScreen/adding-drink?drink=beer-cider`)}
                            >
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => router.push(`/checkInScreen/adding-drink?drink=wine-fizz`)}
                            >
                                <View style={styles.drinkChoosingBtn}>
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => router.push(`/checkInScreen/adding-drink?drink=spirits-shots`)}
                            >
                                <View style={styles.drinkChoosingBtn}>
